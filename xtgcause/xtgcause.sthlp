...
{phang2}{cmd:. import excel "https://raw.githubusercontent.com/timbulwidodostp/xtgcause/main/xtgcause/xtgcause.xlsx", sheet("Sheet1") firstrow clear}{p_end}

{phang2}{cmd:. xtset firm year}{p_end}

{phang2}{cmd:. xtgcause inv value}{p_end}

{phang2}{cmd:. xtgcause inv value, lag(2)}{p_end}
